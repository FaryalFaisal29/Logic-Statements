...
let weather = "cloudy";
if (weather === "raining") {console.log("you wear a raincoat.");
} else if (weather === "cloudy") {console.log("you wear a light jacket.");
} else {console.log("you wear sunglasses.");
}

// If you get 80% marks you will get A*, Else you get 70% marks you will get A, otherwise you will get B.

let results = "65";
if (results === "80") {console.log("you will get A*");
} else if (results === "70") {console.log("you will get A");
} else {console.log("you will get B");
}